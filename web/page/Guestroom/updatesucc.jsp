...
<table class="table table-bordered table-hover definewidth m10">
    <tr style="display: none">
        ...
        <td><input type="hidden" name="guestroom.roomid" readonly="readonly" value="${requestScope.update.roomid}"/>
        </td>
    </tr>
    <tr>
        <td class="tableleft"  width="250px">房间号</td>
        <td><input type="text" name="guestroom.roomno" id="roomno" readonly="readonly" value="${requestScope.update.roomno}" />
    ...
    <tr>
    	...
    	<td>
    		<select id="${requestScope.update.roomtype }" class="sel1" name="guestroom.roomtype" readonly="readonly">
    ...
    <tr>
    	...
    	<td><input type="text" name="guestroom.roomprice" id="roomprice" readonly="readonly" value="${requestScope.update.roomprice}" onblur="checkroomprice()"/>
   ...
   <!--  <tr>
    ...
    <tr>
    	...
    	<td><input type="text" name="guestroom.roomtel" id="roomtel" readonly="readonly" value="${requestScope.update.roomtel}" onblur="checkroomtel()"/>
    ...
    <tr>
    	...
    	<td>
    		<select id="${requestScope.update.roomdiscount}" class="sel2" name="guestroom.roomdiscount" readonly="readonly">
