...
var max_notes =8; // maximum number of notes one can store
var allowed_tags = '<br /><br><ol></ol><ul></ul><li></li><strong></strong><i></i>';
var html5sticky = {};
var note_index = 0;//第几个便签
// add a note：添加便签的操作
html5sticky.addNote = function() {
  ...
  // unique localstorage identifier for this sticky note//为每一个标签设置一个标识
  var nindex = ++note_index + 'stickynote';//便签的id
  var dated = html5sticky.getDateTime();
  var dateStr = new Date();//便签的日期
  // get random color
  var bgcolor = html5sticky.getColor();//便签 的颜色
